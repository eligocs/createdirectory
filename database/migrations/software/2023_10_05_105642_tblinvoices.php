...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tblinvoices', function (Blueprint $table) {
            ...
            $table->varchar('deleted_customer_name', 100)->nullable();
            $table->integer('number');
            $table->varchar('prefix', 50)->nullable();
            ...
            $table->varchar('discount_type', 30);
            $table->integer('recurring')->default(0);
            $table->varchar('recurring_type', 10)->nullable();
            ...
            $table->varchar('billing_street', 200)->nullable();
            $table->varchar('billing_city', 100)->nullable();
            $table->varchar('billing_state', 100)->nullable();
            $table->varchar('billing_zip', 100)->nullable();
            $table->integer('billing_country')->nullable();
            $table->varchar('shipping_street', 200)->nullable();
            $table->varchar('shipping_city', 100)->nullable();
            $table->varchar('shipping_state', 100)->nullable();
            $table->varchar('shipping_zip', 100)->nullable();
            ...
            $table->varchar('short_link', 100)->nullable();
            $table->varchar('Array', 255)->nullable();
            $table->varchar('advance_to_merge', 255)->nullable();
            $table->varchar('merge_advance', 255)->nullable();
            $table->varchar('removed_items', 255)->nullable();
