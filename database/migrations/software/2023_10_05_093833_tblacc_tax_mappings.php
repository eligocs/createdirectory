...
return new class extends Migration
{
    ...
    {
        Schema::create('tblacc_tax_mappings', function (Blueprint $table) {
            $table->id();
            ...
            // $table->foreign('tax_id')->references('id')->on('your_tax_table_name');
    ...
    {
        Schema::dropIfExists('tblacc_tax_mappings');
    }
};
